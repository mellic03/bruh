...
export class ImgWrapper extends ShapedAssetEntity {
    ...
    _draw(x = this.x, y = this.y, rotation = this.rotation, xscale, yscale){ //internal lib draw
        ...
        this.#pen.context.scale(xscale, yscale);
    ...
    draw(xscale=1.0, yscale=xscale) {
        ...
        this._draw(x,y,rotation, xscale, yscale);
    }
}
